...
db.draftProfile = require('./draftProfile.js')(sequelize, Sequelize)
...
db.draftProfile.belongsTo(db.user, {foreignKey: 'userId', as: 'user'})
db.user.hasOne(db.draftProfile, {foreignKey: 'userId', as: 'draftProfile'})
